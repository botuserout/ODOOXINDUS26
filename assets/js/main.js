$(document).ready(function () {
    ...
    if (typeof gsap !== 'undefined' && document.querySelector(".faculty-track")) {
        ...
        const facultyList = [
            ...
            // Committee Members
            { name: "Ms. Krupa Chudasama", role: "Registration Team", image: "assets/img/updated_faculty/Krupaba Chudasama.jpg" },
            ...
            { name: "Mr. Vatsal Suthar", role: "Food Team", image: "assets/img/updated_faculty/Vatsal Suthar.webp" },
            { name: "Ms. Shreya Bhatt", role: "Food Team", image: "assets/img/updated_faculty/Shreya Bhatt.webp" },
            { name: "Ms. Vrushali Rajvanshi", role: "Social Media & Backstage", image: "assets/img/updated_faculty/Vrushali Rajvanshi (CSE).webp" },
            { name: "Ms. Zarna Kotak", role: "Social Media & Hospitality", image: "assets/img/updated_faculty/Zarana Kotak (IITE).webp" },
            { name: "Dr. Shweta Brahmbhatt", role: "Hospitality Team", image: "assets/img/updated_faculty/Dr Shweta.webp" },
            { name: "Ms. Anjali Chopra", role: "Hospitality & Backstage", image: "assets/img/updated_faculty/Anjali Chopra (IITE).webp" },
    ...
    // Particle Initialization with Theme Colors
    // MOBILE OPTIMIZATION: Disable movement and loop if mobile
    // Helper to get speed or 0
    const mobSpeed = (min, max) => isMobile ? 0 : [min, max]; // Logic handled below inline to avoid complex array passing if not supported

    if (document.getElementById('particles-foreground')) {
        const pgfg = particleground(document.getElementById('particles-foreground'), {
            dotColor: 'rgba(255, 255, 255, 1)',
            lineColor: 'rgba(255, 255, 255, 0.05)',
            minSpeedX: isMobile ? 0 : 0.3,
            maxSpeedX: isMobile ? 0 : 0.6,
            minSpeedY: isMobile ? 0 : 0.3,
            maxSpeedY: isMobile ? 0 : 0.6,
            density: 50000,
            curvedLines: false,
            proximity: 250,
        ...
        // Stop the loop immediately on mobile to prevent CPU usage/stutter
        if (isMobile) pgfg.pause();
    }

    if (document.getElementById('particles-background')) {
        const pgbg = particleground(document.getElementById('particles-background'), {
            dotColor: 'rgba(255, 255, 255, 0.5)',
            lineColor: 'rgba(255, 255, 255, 0.05)',
            minSpeedX: isMobile ? 0 : 0.075,
            maxSpeedX: isMobile ? 0 : 0.15,
            minSpeedY: isMobile ? 0 : 0.075,
            maxSpeedY: isMobile ? 0 : 0.15,
            density: 30000,
            curvedLines: false,
            proximity: 20,
            parallax: !isMobile, // Disable parallax on mobile
